...
KGR_SYSCALL_DEFINE3(v1, read, unsigned int, fd, char __user *, buf, size_t, count)
{
...
static struct kgr_patch patch = {
	.name = "qa_sys_read_patcher",
	.owner = THIS_MODULE,
	.patches = {
		KGR_PATCH(SyS_read, KGR_PATHED_SYSCALL_NAME(v1, read), true),
		KGR_PATCH_END
	}
};
