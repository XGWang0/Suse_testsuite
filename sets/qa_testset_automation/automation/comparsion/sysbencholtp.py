...
from dod import *
from logdir.logdirSysbencholtp import *
...
ext3_sysbencholtp_sp3_GA_url_list = (
   'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11/RC2/x86_64/apac2-ph027.apac.novell.com/sysbench-oltp-2015-05-23-15-13-51/',
   'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11/RC2/x86_64/apac2-ph027.apac.novell.com/sysbench-oltp-2015-05-23-15-05-07/',)

#not real data used to test
ext3_sysbencholtp_sp4_RC1_url_list = (
...
ext3_sysbencholtp_sp3_GA_dod_group = get_dodgroup_from_url_list(ext3_sysbencholtp_sp3_GA_url_list,
                                                          logDirRecordSysbencholtp, ext3log, downloadp = False)

for log_name in ext3_sysbencholtp_sp3_GA_dod_group:
    dod_group = ext3_sysbencholtp_sp3_GA_dod_group[log_name]
