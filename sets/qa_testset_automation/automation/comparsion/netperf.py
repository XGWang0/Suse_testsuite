...
from dod import *
from logdir.logdirNetperf import *
...
system_netperf_sp3_GA_url_list = (
   'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11/RC2/x86_64/apac2-ph027.apac.novell.com/netperf-peer-loop-2015-05-22-11-22-40/',
   'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11/RC2/x86_64/apac2-ph027.apac.novell.com/netperf-peer-loop-2015-05-22-11-06-48/',
)

#not real data used to test
system_netperf_sp4_RC1_url_list = (
...
system_netperf_sp3_GA_dod_group = get_dodgroup_from_url_list(system_netperf_sp3_GA_url_list,
                                                          logDirRecordNetperf, systemlog, downloadp = False)

for log_name in system_netperf_sp3_GA_dod_group:
    dod_group = system_netperf_sp3_GA_dod_group[log_name]
