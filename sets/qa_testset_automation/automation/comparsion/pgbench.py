...
from dod import *
from logdir.logdirPgbench import *
...
ext3_pgbench_sp3_GA_url_list = (
   'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11-SP3/GMC/x86_64/apac2-ph027.apac.novell.com/qa_test_pgbench-small-2015-02-18-02-11-07/',
   'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11-SP3/GMC/x86_64/apac2-ph027.apac.novell.com/qa_test_pgbench-small-2015-02-18-02-11-08/',
)

#not real data used to test
ext3_pgbench_sp4_RC1_url_list = (
    #'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11-SP3/GMC/x86_64/apac2-ph027.apac.novell.com/qa_test_pgbench-small-2015-02-18-02-11-07/',
)
...
ext3_pgbench_sp3_GA_dod_group = get_dodgroup_from_url_list(ext3_pgbench_sp3_GA_url_list,
                                                          logDirRecordPgbench, ext3log, downloadp = False)

for log_name in ext3_pgbench_sp3_GA_dod_group:
    dod_group = ext3_pgbench_sp3_GA_dod_group[log_name]
