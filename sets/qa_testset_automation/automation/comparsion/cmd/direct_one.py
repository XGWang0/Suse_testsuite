...
rl=['beta1','beta2','beta3','beta4','RC1','RC2','GMC','GMC2','GM','GA']
...
def Usage():
    ...
    print ('-r, choose release version:[0:beta1,1:beta2,2:beta3,3:beta4,4:RC1,5:RC2,6:GMC1,7:GMC2,8:GM,9:GA]')
...
def getpara(argv):
    try:
        ...
        opts,args = getopt.getopt(sys.argv[1:],"n:p:r:a:t:l:n:")
        if len(opts)<5:
            print ("please give me the params:-p product,-r release,-a arch,-t testsuite,-l logname -f filesystem")
            Usage()
            sys.exit(1)
