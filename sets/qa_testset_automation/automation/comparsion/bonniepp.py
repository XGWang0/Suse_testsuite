...
from dod import *
from logdir.logdirBonniepp import *
...
ext3_bonniepp_sp3_GA_url_list = (
   'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11-SP3/GMC/x86_64/apac2-ph027.apac.novell.com/bonnie++-async-2015-05-25-04-53-07/',
   'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11-SP3/GMC/x86_64/apac2-ph027.apac.novell.com/bonnie++-async-2015-05-25-07-41-53/',
)

#not real data used to test
ext3_bonniepp_sp4_RC1_url_list = (
...
ext3_bonniepp_sp3_GA_dod_group = get_dodgroup_from_url_list(ext3_bonniepp_sp3_GA_url_list,
                                                          logDirRecordBonniepp, ext3log, downloadp = False)

for log_name in ext3_bonniepp_sp3_GA_dod_group:
    dod_group = ext3_bonniepp_sp3_GA_dod_group[log_name]
