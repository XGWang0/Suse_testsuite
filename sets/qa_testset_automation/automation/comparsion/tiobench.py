...
from dod import *
from logdir.logdirTiobench import *
...
ext3_tiobench_sp3_GA_url_list = (
   'http://w3.suse.de/~rd-qa/Results/ProductTests/SLES-11-SP3/GM/ia64/ia64ph1007/tiobench-basic-2015-03-04-12-27-40/',
)

#not real data used to test
ext3_tiobench_sp4_RC1_url_list = (
...
ext3_tiobench_sp3_GA_dod_group = get_dodgroup_from_url_list(ext3_tiobench_sp3_GA_url_list,
                                                          logDirRecordTiobench, ext3log, downloadp = False)

for log_name in ext3_tiobench_sp3_GA_dod_group:
    dod_group = ext3_tiobench_sp3_GA_dod_group[log_name]
