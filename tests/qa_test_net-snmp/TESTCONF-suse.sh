...
SNMP_QA_LOCATION="/usr/share/qa/qa_test_net-snmp"
SNMP_TESTDIR="$SNMP_QA_LOCATION/testing/tests"
...
SNMP_PERLPROG="`/usr/bin/net-snmp-config --perlprog`"
