#
# spec file for package qa_test_php7
#
...
%define qa_location %{_datadir}/qa/qa_test_php7
%define qa_server_location /srv/www/htdocs/php7-tests
Name:           qa_test_php7
Version:        7.0.11
Release:        0
...
Source1:        test_php7-run
Source2:        qa_test_php7.8
Source3:        apache2-php7-prepare.sh
Source4:        test_php7-server-run
...
Requires:       php7-xsl
Requires:       php7-zlib
Provides:       qa_test_php7
Obsoletes:      qa_test_php7
...
Provides:       qa_php7-server
Obsoletes:      qa_php7-server
...
touch %{buildroot}%{qa_location}/tcf/qa_php7.tcf
touch %{buildroot}%{qa_location}/tcf/qa_php7-server.tcf
ln -s ../qa_test_php7/tcf/qa_php7.tcf %{buildroot}%{_datadir}/qa/tcf/
ln -s ../qa_test_php7/tcf/qa_php7-server.tcf %{buildroot}%{_datadir}/qa/tcf/
...
cat -n %{qa_location}/ctcs2_test_order | grep -v '[0-9]*[ ]*#' | while read test_num line; do
    ...
    echo -en "wait\n\n"
done > %{qa_location}/tcf/qa_php7.tcf
...
cat -n %{qa_location}/ctcs2_test_order | grep -v '[0-9]*[ ]*#' | while read test_num line; do
    ...
    echo -en "wait\n\n"
done > %{qa_location}/tcf/qa_php7-server.tcf

%files
%defattr(-, root, root)
%{_mandir}/man8/qa_test_php7.8%{ext_man}
%{_datadir}/qa/
%{_datadir}/qa/tcf/qa_php7.tcf
%{_datadir}/qa/tools
%exclude %{_datadir}/qa/tcf/qa_php7-server.tcf
%exclude %{_datadir}/qa/tools/test_php7-server-run
%exclude %{qa_location}/tcf/qa_php7-server.tcf
...
%defattr(-, root, root)
%{qa_server_location}
%{_datadir}/qa/tcf/qa_php7-server.tcf
%{_datadir}/qa/tools/test_php7-server-run
%{qa_location}/tcf/qa_php7-server.tcf
