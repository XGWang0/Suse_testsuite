...
Requires:       ctcs2, apache2, at, audit, brltty, cups, cron, cyrus-sasl-saslauthd, device-mapper, dovecot, dnsmasq, gpm, haveged, kexec-tools, libvirt, lvm2, mariadb, mcelog, mdadm, multipath-tools, nfs-client, nfsidmap, nfs-kernel-server, nscd, openslp-server, pcsc-lite, postfix, postgresql-server, quota, radvd, rpcbind, rsync, rsyslog, samba, samba-winbind, spice-vdagent, SuSEfirewall2, smartmontools, systemd, vsftpd, yast2-nfs-server, xinetd
Version:        1
Release:        1
