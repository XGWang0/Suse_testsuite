...
OpenOffice files:
Step1: Create 'test.ods', 'test.odt', 'test.odp' in '~/'
Step2: Open 'test.ods', 'test.odt', 'test.odp'
Step3: Make sure files are opened by OpenOffice
"""
...
for i in oo_files:
    ...
    # Step2: Open file 'test.ods', 'test.odt', 'test.odp'
    # Step3: Make sure files are opened by OpenOffice
    (opened_app, app) = openFileTest(i, 'soffice')
