...
crm_mon -1
  ...
  echo "       iscsi_disk - disk used for sbd/STONITH [/dev/disk/by-path/ip-10.20.138.1:3260-iscsi-iqn.2010-11.suse.qa:1d1fc26d-1bf8-47be-b67c-c7bcdb676508-lun-2-part1]"
fi
