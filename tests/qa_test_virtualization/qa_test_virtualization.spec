...
sed "/$list/!d" $RPM_BUILD_ROOT/usr/share/qa/%name/tcf/qa_virtualization-virt_install.tcf > $RPM_BUILD_ROOT/usr/share/qa/%name/tcf/qa_virtualization-sles10sp4supported-virt_install.tcf
...
sed "/$list/!d" $RPM_BUILD_ROOT/usr/share/qa/%name/tcf/qa_virtualization-virt_install.tcf > $RPM_BUILD_ROOT/usr/share/qa/%name/tcf/qa_virtualization-sles11sp1supported-virt_install.tcf
