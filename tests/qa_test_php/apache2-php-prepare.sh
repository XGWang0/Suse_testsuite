...
[ -e /etc/php7/apache2/php.ini ] && phpini="/etc/php7/apache2/php.ini"
[ -e /etc/php5/apache2/php.ini ] && phpini="/etc/php5/apache2/php.ini"
...
[ -e /etc/php7/apache2/php.ini ] && add_module php7
[ -e /etc/php5/apache2/php.ini ] && add_module php5
